...
/// 绿色响尾蛇
/// </summary>
public class SidewinderGreen : ShotGun
{
    public SidewinderGreen(GameObject gameObject, Character owner, WeaponModel model) : base(gameObject, owner, model) { }
    ...
    protected override void OnFire()
    {
        ...
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            ItemFactory.Instance.CreateBullet(BulletType.Bullet_27, shootPoint.transform.position, quaternion,
